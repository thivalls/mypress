...
/**
 * @return \src\Core\Message
 */
function message(): \src\Core\Message
{
    return new \src\Core\Message();
}

/**
 * @return \src\Core\Session
 */
function session(): \src\Core\Session
{
    return new \src\Core\Session();
}
